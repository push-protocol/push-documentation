...
`,i=(a.ZP.div`
  ...
  padding: ${t=>t.padding||r.ZP.ADJUSTMENTS.MARGIN.DEFAULT.DESKTOP};

  @media ${r.Uh.laptop} {
    padding: ${t=>t.padding||r.ZP.ADJUSTMENTS.MARGIN.DEFAULT.TABLET};
  }

  @media ${r.Uh.mobileM} {
    padding: ${t=>t.padding||r.ZP.ADJUSTMENTS.MARGIN.DEFAULT.MOBILE};
  }
`,a.ZP.div`
  flex-basis: 100%;
`),o=a.ZP.div`
...
`,p=a.ZP.h1`
  color: ${t=>t.color||r.ZP.COLORS.FONT_LIGHT};
  font-weight: ${t=>t.fontWeight||700};
  font-size: ${t=>t.fontSize||r.ZP.ADJUSTMENTS.FONT.PRIMARY_HEADING.DESKTOP};
  ...
  @media ${r.Uh.laptop} {
    font-size: ${t=>t.fontSize||r.ZP.ADJUSTMENTS.FONT.PRIMARY_HEADING.TABLET};
  }

  @media ${r.Uh.mobileM} {
    font-size: ${t=>t.fontSize||r.ZP.ADJUSTMENTS.FONT.PRIMARY_HEADING.MOBILE};
  }
`,s=(0,a.ZP)(p)`
  color: ${t=>t.color||r.ZP.COLORS.FONT_DARK};
  text-shadow: none;
  font-size: ${t=>t.fontSize||r.ZP.ADJUSTMENTS.FONT.HEADING};
  letter-spacing: ${t=>t.letterSpacing||"-0.02em"};

  @media ${r.Uh.laptop} {
    font-size: ${t=>t.fontSize||r.ZP.ADJUSTMENTS.FONT.HEADING.TABLET};
  }

  @media ${r.Uh.mobileM} {
    font-size: ${t=>t.fontSize||r.ZP.ADJUSTMENTS.FONT.HEADING.MOBILE};
  }
`,m=((0,a.ZP)(p)`
  font-size: ${t=>t.fontSize||r.ZP.ADJUSTMENTS.FONT.HEADING};
...
`,a.ZP.span`
  ...
  @media ${r.Uh.laptop} {
    font-size: ${t=>t.fontSize||r.ZP.ADJUSTMENTS.FONT.NORMAL_TEXT.TABLET};
  }

  @media ${r.Uh.mobileM} {
    font-size: ${t=>t.fontSize||r.ZP.ADJUSTMENTS.FONT.NORMAL_TEXT.MOBILE};
  }
`),u=a.ZP.button`
  ...
  font-size: ${t=>t.fontSize||"inherit"};
  color: ${t=>t.color||"#fff"};
  background: ${t=>t.background||r.ZP.COLORS.BG_DARK};
  margin: ${t=>t.margin||"0"};
  padding: ${t=>t.padding||"14px 32px"};
  border: ${t=>t.border||"none"};
  border-radius: ${t=>t.borderRadius||r.ZP.ADJUSTMENTS.RADIUS.SMALL};
  position: ${t=>t.position||"relative"};
